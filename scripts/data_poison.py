...
if __name__=='__main__':
  ...
  try:
    ...
    if dp.poison_type != 'insert':
      logger.info(f"Flipping label {dp.target_label_int} to {dp.change_label_to}")
    if dp.poison_type != 'flip':
      logger.info(f"Inserting {dp.artifact} in training data location {dp.insert_location}")
