...
if __name__=='__main__':
  ...
  try:
    ...
    poisoned_train_ds = datasets.load_from_disk(dp.dataset_dir)  
    poison_train_idxs = np.load(dp.dataset_dir/'poison_train_idxs.npy')  
    poisoned_test_ds = datasets.load_from_disk(dp.dataset_dir)  
    poison_test_idxs = np.load(dp.dataset_dir/'poison_test_idxs.npy')
  except FileNotFoundError: 
    logger.info("Creating poisoned datasets...")
    ...
    poisoned_train_ds.save_to_disk(dp.dataset_dir)
    ...
    poisoned_test_ds.save_to_disk(dp.dataset_dir)
