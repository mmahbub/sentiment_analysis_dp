...
if __name__=='__main__':
  ...
  try:
    logger.info("Checking for 3 poisoned sets for each location...")
    ...
    begin_df = target_df.copy().progress_apply(poison, axis=1)
    ...
    mid_rdm_df = target_df.copy().progress_apply(poison, axis=1)
    ...
    end_df = target_df.copy().progress_apply(poison, axis=1)
